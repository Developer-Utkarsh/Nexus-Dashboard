...
export default function SignIN() {
	...
	return (
		<main className='w-full min-h-screen flex flex-col items-center justify-center sm:px-4 relative'>
			<div className='absolute top-0 z-[0] h-full w-screen bg-[#000] bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]'></div>
			<div className='w-full space-y-4 text-gray-600 max-sm:max-w-[95%] sm:max-w-md md:max-w-lg lg:max-w-md px-4 pt-8 pb-4 rounded-2xl transform-gpu [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#8686f01f_inset]'>
				<div className='text-center'>
					...
					<div className='mt-4 space-y-0'>
						<h3 className='text-gray-200 text-3xl font-normal tracking-tighter font-geist'>
							Log in to{" "}
				...
				<SignIn.Root>
					<SignIn.Step
						name='start'
						className='bg-transparent shadow p-4 py-2 space-y-5 sm:p-2 sm:rounded-lg'
					>
						<div className='grid grid-cols-2 gap-x-3'>
							<Clerk.Connection
								...
								className='group flex transform-gpu [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#8686f01f_inset] items-center justify-center py-5 border rounded-lg hover:bg-transparent/50 duration-150 active:bg-transparent/50 gap-4 text-zinc-100 hover:text-white'
							>
								<svg
									className={cn(
							...
							<Clerk.Connection
								...
								onMouseEnter={() => setReset(false)}
								onMouseLeave={() => setReset(true)}
								className='group flex transform-gpu [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#8686f01f_inset]  items-center justify-center py-5 border rounded-lg hover:bg-transparent/50 duration-150 active:bg-transparent/50 text-zinc-100 hover:text-white gap-4'
							>
								<svg
									className={cn(
						...
						>
							<Clerk.Label className='font-medium text-gray-100/75 font-geist'>
								Email or Username
							</Clerk.Label>
							<Clerk.Input
								type='text'
								...
								className='w-full mt-2 px-3 py-3 text-gray-500 bg-transparent outline-none  focus:border-purple-600 shadow-sm rounded-lg [border:1px_solid_rgba(255,255,255,.1)] hover:border-purple-600 transition '
							/>
						...
						>
							...
							<Clerk.Input
								...
								className='w-full mt-2 px-3 py-3 text-gray-500 bg-transparent outline-none border focus:border-purple-600 shadow-sm rounded-lg [border:1px_solid_rgba(255,255,255,.1)] hover:border-purple-600 transition'
							/>
						...
						<SignIn.Action
							submit
							className='w-full group px-2 py-3 font-geist tracking-loose text-lg text-white font-medium bg-purple-200/10 transform-gpu [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#8686f01f_inset] hover:bg-transparent/10 active:bg-purple-600 rounded-lg duration-150'
						>
							Sign in
				...
				<div className='flex bottom-0 border-t border-gray-500 w-full bg-dark-1 p-1 text-gray-400 justify-between items-center hover:text-slate-300 transition  '>
